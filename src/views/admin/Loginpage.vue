        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="brand-logo">
                <a href="#">
                    ...
                    <div style="color:gray;">e-Billing Admin</div>
                </a>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <form id="frm_login-admin" name="frm_login-admin" @submit.prevent="submitLogin">
...
export default {
    ...
    methods: {
        ...
        submitLogin(){
            const form = $('#frm_login-admin')[0];
			const data = new FormData(form);
			const proxy = this;

			axios.post(this.url+'intsys/ebilling/ebilling_backend/apiadmin/checklogin_admin' , data,{
